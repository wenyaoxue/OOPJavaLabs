...
public abstract class Employee implements Certification {
    ...
    protected static BufferedWriter pmWriter, tapWriter, tacWriter;
    public static void openWriters() throws IOException {
    	pmWriter = new BufferedWriter(new FileWriter(new File("pmreport.txt")));
    	tapWriter = new BufferedWriter(new FileWriter(new File("tapreport.txt")));
    	tacWriter = new BufferedWriter(new FileWriter(new File("tacreport.txt")));
    }
