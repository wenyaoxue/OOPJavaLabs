...
public class TechnicalAssociateContr extends ContractEmployee {
	...
	public TechnicalAssociateContr(String fn, String ln, int grd, GregorianCalendar joined, double wage, String[] potCerts) throws IOException {
	...
	public String toString() {
		String retVal = id + " " + name + " TA-C\tCertifications: ";
